...
async function getCounts(secrets) {
  try {
    ...
    // if (!secrets.begin) { secrets.begin = new Date(new Date().setHours(0, 0, 0, 0)).toISOString().substring(0, 11) + '00:00:00.000'; } // today midnight
    // if (!secrets.end) { secrets.end = new Date(new Date().setHours(0, 0, 0, 0)).toISOString().substring(0, 11) + '01:00:00.000'; } // today 1am
